...
export default function CodexSidebar({ sessions = [], activeId, query = '', onQuery, onNew, onOpen, onRename, onDelete, onReplay, onMode, onPlans, onHome, mode = 'chat' }) {
  ...
  return <aside className="pcx-sidebar">
    ...
    <nav className="pcx-nav" aria-label="Navegação do Codex">
      ...
      <button onClick={onPlans}>Planos <small>conta</small></button>
    ...
    <div className="pcx-history"><div className="pcx-history-head"><span>Conversas</span><b>{visible.length || ''}</b></div>
