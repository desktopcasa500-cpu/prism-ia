...
export default function PrismCodexIntro({ onComplete }) {
  ...
  return (
    <section className="prism-codex-intro prism-codex-intro--edit" aria-label="Introdução do Prism Codex">
      ...
      <div className="edit-rulers" aria-hidden="true">
        <span>00:00:00:00</span><b>PRISM / CODEX / EDIT_01</b><span>56.00s</span>
      </div>
      <div className="edit-corners" aria-hidden="true"><span>REC</span><i /><span>01—08</span></div>

      <div className="edit-title" aria-hidden="true">
        <div className="edit-micro">PRISM AI / COMPUTATIONAL CULTURE / 2026</div>
        <div className="edit-prism">PRISM</div>
        <div className="edit-ai">AI</div>
        <div className="edit-stamp">NO. 001<br />SYSTEM / MOTION</div>
      </div>
      ...
      <div className="edit-editorial" aria-hidden="true">
        ...
        <div className="edit-editorial-bottom"><span>HUMAN × MACHINE</span><span>PRISM RESEARCH</span><span>BUILD / RUN / REVIEW</span></div>
      </div>

      <div className="edit-columns" aria-hidden="true">
