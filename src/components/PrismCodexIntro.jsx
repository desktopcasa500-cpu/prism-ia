...
export default function PrismCodexIntro({ onComplete }) {
  ...
  return (
    <section className="prism-codex-intro" aria-label="Introdução do Prism Codex">
      ...
      <div className="intro-scene intro-scene-codex">
        <div className="intro-prism-small">PRISM AI</div>
        <div className="intro-codex-word">CODEX</div>
        <div className="intro-all-in-one">ALL IN ONE</div>
      </div>
      ...
      <div className="intro-scene intro-scene-chat">
        ...
        <div className="intro-composer">
          <span className="intro-composer-text">{typed}<i className={typed ? 'typing-caret' : ''} /></span>
          <div className={`intro-model-picker ${modelReady ? 'ready' : ''}`}><span>Prism Taff 2.0</span><b>⌄</b></div>
        </div>
      </div>

      <div className="intro-model-popover" aria-hidden={!modelReady}>
