...
const models = [['Nano 1.0A','rápido'],['Mini 1.0','equilibrado'],['Edge 1.0A','raciocínio'],['Tex 1.0A','técnico'],['Taff 2.0','flagship']];
  ...
  return <div className="auth-page">
    <section className="auth-side">
      ...
      <div className="auth-copy">
        ...
        <div className="auth-presentation"><div className="auth-presentation-head"><span>Uma plataforma. Cinco perfis.</span><span>01—05</span></div><div className="auth-models">{models.map(([name,label]) => <div className="auth-model" key={name}><strong>Prism {name}</strong><span>{label}</span></div>)}</div></div>
      </div>
    ...
    <main className="auth-panel">
      <div className="auth-box">
        <div className="auth-kicker">Prism IA / acesso</div><h2>Entrar</h2><p className="lede">Continue exatamente de onde parou.</p>
      ...
      <div className="auth-orbit" aria-hidden="true"><img className="auth-mascot" src="/prism-panda.svg" alt="" /></div>
    </main>
  </div>;
}
